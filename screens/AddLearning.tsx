...
const AddLearning: React.FC = () => {
  ...
  const handleSubmit = async () => {
    if (selectedCourseKey) {
      await firestore().collection('learning').doc(user?.uid).collection('courses').add({ course: selectedCourseKey });
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Pressable
          style={[styles.submitButton, !selectedCourseKey && styles.submitButtonDisabled]}
